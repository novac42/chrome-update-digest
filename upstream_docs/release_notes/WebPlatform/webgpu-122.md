# WebGPU 122 Release Notes

Source: https://developer.chrome.com/blog/new-in-webgpu-122
...
In the meantime, learn how to [supercharge your Web AI model testing with WebGPU and WebGL support in Headless Chrome](/blog/supercharge-web-ai-testing) and [why WebGPU may be disabled or not working in Chrome](/docs/web-platform/webgpu/troubleshooting-tips).
...
![Diagram of WebGPU compatibility mode.](/static/blog/new-in-webgpu-122/image/compatibility-mode.svg) WebGPU compatibility mode expanded reach.
