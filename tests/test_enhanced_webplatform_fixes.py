...
async def test_prompt_loading():
    ...
    print("✅ Bilingual mode defaults to EN (no bilingual file)")
...
async def test_sampling_parameters():
    ...
    print("✅ Sampling uses correct 'messages' parameter")
    print("✅ Sampling response handled correctly")
...
async def test_sampling_fallback():
    ...
    for content_type in ['content', 'text', 'none']:
        ...
        print(f"✅ Handles response with {content_type} attribute")
    ...
    print("✅ Falls back to non-LLM digest on sampling failure")
...
async def test_resource_loading():
    ...
    try:
        ...
        print("✅ Resource loading no longer raises NotImplementedError")
    except NotImplementedError:
        print("❌ NotImplementedError still present in resource loading")
        return False
    except Exception as e:
        # Other exceptions are OK (file not found, etc.)
        print(f"✅ Resource loading handles errors gracefully: {type(e).__name__}")
...
async def test_bilingual_generation():
    ...
    print("✅ Bilingual mode would generate separate EN and ZH files")
