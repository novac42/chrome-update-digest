...
- [CSS](./css/index.html) - Updates in 11 versions — CSS styling, layout, and UI features
- [HTML-DOM](./html-dom/index.html) - Updates in 9 versions — HTML elements and DOM manipulation
- [Graphics and WebGPU](./graphics-webgpu/index.html) - Updates in 11 versions — Graphics rendering and WebGPU features
...
- [Origin trials](./origin-trials/index.html) - Updates in 10 versions — Experimental features in origin trials
...
- [Multimedia](./multimedia/index.html) - Updates in 9 versions — Media, audio, and video features
- [Performance](./performance/index.html) - Updates in 7 versions — Performance optimizations and improvements
- [Devices](./devices/index.html) - Updates in 6 versions — Device APIs and sensor features
...
- [Isolated Web Apps](./isolated-web-apps/index.html) - Updates in 2 versions — Isolated Web Apps (IWAs) and related features
- [JavaScript](./javascript/index.html) - Updates in 7 versions — JavaScript language features and runtime updates
...
- [Network](./network/index.html) - Updates in 4 versions — Networking and connectivity features
...
- [Storage](./storage/index.html) - Updates in 5 versions
